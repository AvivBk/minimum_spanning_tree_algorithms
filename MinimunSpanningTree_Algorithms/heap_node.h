...
namespace minimum_spanning_tree
{
	...
	public:
		...
		heap_node(const int i_vertex_num) : m_data(i_vertex_num), m_key(INT_MAX), m_prev(nullptr), m_next(nullptr) {}
		heap_node(const int i_vertex_num, const int i_key) : m_data(i_vertex_num), m_key(i_key), m_prev(nullptr), m_next(nullptr) {}
